...
EEPROM_Read_Program_8:
	...
	mov	r0,#EFXTYPE
	movx	a,@r0				;EFX TYPE							
	cjne	a,#08h,$+3			;0-7 = interne Programme
	jnc	EEPROM_Read_Program_1		;wenn < 8 dann 
	anl	a,#00000111b			;Programmwerte 0-7
	orl	a,#01110000b			;T0=0 für interne EFX-Programme, E1-E3 = DIS
	mov	EFX_Select,a
	jmp	EEPROM_Read_Program_4
EEPROM_Read_Program_1:
	cjne	a,#16,$+3
	jnc	EEPROM_Read_Program_2		;wenn >7 und <16 dann 
	anl	a,#00000111b			;Programmwerte 0-7
	orl	a,#01101000b			;E1=0 für extEEPROM1
	mov	EFX_Select,a
	jmp	EEPROM_Read_Program_4
EEPROM_Read_Program_2:
	cjne	a,#24,$+3
	jnc	EEPROM_Read_Program_3		;wenn >15 und <24 dann 
	anl	a,#00000111b			;Programmwerte 0-7
	orl	a,#01011000b			;E2=0 für extEEPROM2
	mov	EFX_Select,a
	jmp	EEPROM_Read_Program_4
EEPROM_Read_Program_3:
	anl	a,#00000111b			;wenn >23 und <32 dann Programmwerte 0-7
	orl	a,#00111000b			;E3=0 für extEEPROM3
	mov	EFX_Select,a
EEPROM_Read_Program_4:
